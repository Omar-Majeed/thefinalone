    ...
    <section ref={ref} className="bg-[#0c0c0c] py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-base leading-8 text-[#6B7280] sm:text-lg max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <p className="text-xs text-gray-600 mt-2 font-medium">Scale: 0–75 (industry competitive range)</p>
              </div>
            </div>
          </div>
        </motion.div>
